...
export default function getClientBundleEntryAssets() {
  ...
  if (typeof assetsJSONCache['webpack-initiator'] === 'undefined' && !process.env.BUILD_FLAG_IS_DEV) {
    throw new Error('No asset data found for expected "webpack-initiator" entry chunk of client bundle.');
  }
  if (typeof assetsJSONCache['vendor-all'] === 'undefined' && !process.env.BUILD_FLAG_IS_DEV) {
    throw new Error('No asset data found for expected "vendor-all" entry chunk of client bundle.');
  }
  if (typeof assetsJSONCache['vendor-splitted-beta'] === 'undefined' && !process.env.BUILD_FLAG_IS_DEV) {
    throw new Error('No asset data found for expected "vendor-splitted-beta" entry chunk of client bundle.');
  }
  if (typeof assetsJSONCache['vendor-splitted-alpha'] === 'undefined' && !process.env.BUILD_FLAG_IS_DEV) {
    throw new Error('No asset data found for expected "vendor-splitted-alpha" entry chunk of client bundle.');
  }
  if (typeof assetsJSONCache['vendor-splitted-omega'] === 'undefined' && !process.env.BUILD_FLAG_IS_DEV) {
    throw new Error('No asset data found for expected "vendor-splitted-omega" entry chunk of client bundle.');
  }
  ...
  return {
    webpackInitiator: assetsJSONCache['webpack-initiator'],
    all: assetsJSONCache['vendor-all'],
    splittedAlpha: assetsJSONCache['vendor-splitted-alpha'],
    splittedBeta: assetsJSONCache['vendor-splitted-beta'],
    splittedOmega: assetsJSONCache['vendor-splitted-omega'],
    index: assetsJSONCache.index,
  };
}
